...
var ProductModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        connection = _b.sent();
                        return [4 /*yield*/, database_1.default.query('SELECT * FROM products WHERE id = $1', [id])];
                    case 2:
                        rows = (_b.sent()).rows;
                        connection.release();
                        if (rows.length) {
    ...
    var _a;
    _a = ProductModel;
    ProductModel.add = function (product) { return __awaiter(void 0, void 0, void 0, function () {
        var sql, parameters, connection, rows, error_3;
